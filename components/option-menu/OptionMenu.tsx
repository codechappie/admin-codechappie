...
const OptionMenu: FC<IExpandedMenu> = ({ showExpandedMenu, setExpandedMenu }) => {
    ...
    const searchContentHandler = (e: any) => {
        e.preventDefault();
        router.push(`/contenido${`${searchInputRef.current.value.trim() === '' || !searchInputRef.current.value.trim() ? '?' : `?q=${searchInputRef.current.value.trim()}&`}`}type=cursos`,);
    ...
    return (
        <>
            <div className={style.optionMenu}>
                <div className={style.container}>
                    ...
                    <div className={style.menu__item} title="Buscador">
                        ...
                        <div className={`${style.menu__item__content} ${showSearchForm ? `${style.active}` : ''}`}>
                            <div className={style.overlay} onClick={() => setShowSearchForm(!showSearchForm)}></div>
                            <div className={style.search__form__container}>
                                <div className={style.close__button} onClick={() => setShowSearchForm(!showSearchForm)}>
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        height="35px"
                                        width="35px"
                                        viewBox="0 0 24 24"
                    ...
                    <div className={`${style.menu__item} ${style.close__btn}`} onClick={() => setExpandedMenu(!showExpandedMenu)} title="Menu">
                        {
                            showExpandedMenu ? (
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    height="42px"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    height="38px" viewBox="0 0 24 24"
                                    width="38px" fill="#ffffff">
                                    <path d="M0 0h24v24H0V0z" fill="none" />
            ...
            <ExpandedMenu showExpandedMenu={showExpandedMenu} setExpandedMenu={setExpandedMenu} />
        </>
    )
}
