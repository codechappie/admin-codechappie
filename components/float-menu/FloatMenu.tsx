...
import style from './float-menu.module.scss';
...
const FloatMenu: FC<IExpandedMenu> = ({showExpandedMenu, setExpandedMenu}) => {
        ...
        <>
            <div className={style.floatMenu}>
                <div className={style.container}>
                    ...
                    <div className={style.menu__item} onClick={changeTheme}>
                        {
                            theme === 'theme__dark' && (
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    height="32px"
                    ...
                    <div className={`${style.menu__item} ${style.close__btn}`} onClick={() => setExpandedMenu(!showExpandedMenu)}>
                        {
                            showExpandedMenu ? (
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    height="42px"
