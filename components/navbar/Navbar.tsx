...
export const Navbar: FC<IExpandedMenu> = ({
  setExpandedMenu,
  showExpandedMenu,
}) => {
  return (
      ...
      <div className={style.navbar__container}>
        ...
        <div className={style.icon__menu}>
          ...
          >
            ...
            <span className={style.tooltip}>Cursos</span>
          </Link>
          <Link
            href="/publicaciones"
            onClick={() => setExpandedMenu(false)}
          ...
          >
            ...
            <span className={style.tooltip}>Publicaciones</span>
          </Link>
          <Link
            href="/videos"
            onClick={() => setExpandedMenu(false)}
          ...
          >
            ...
            <span className={style.tooltip}>Videos</span>
          </Link>
          <Link
            href="/enlaces"
            onClick={() => setExpandedMenu(false)}
          ...
          >
            ...
            <span className={style.tooltip}>Enlaces</span>
          </Link>
          ...
          >
            ...
            <span className={style.tooltip}>Blog</span>
          </Link>
        </div>
